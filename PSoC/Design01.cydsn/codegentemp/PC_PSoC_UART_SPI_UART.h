...
****************************************/
    ...
    #define PC_PSoC_UART_CHECK_SPI_WAKE_ENABLE  ((0u != PC_PSoC_UART_scbEnableWake) && PC_PSoC_UART_SCB_MODE_SPI_RUNTM_CFG)
    #define PC_PSoC_UART_CHECK_UART_WAKE_ENABLE ((0u != PC_PSoC_UART_scbEnableWake) && PC_PSoC_UART_SCB_MODE_UART_RUNTM_CFG)
    ...
    /* Internal RX and TX buffer: for SPI or UART */
        ...
        /* Get FIFO size */
        #define PC_PSoC_UART_SPI_UART_FIFO_SIZE PC_PSoC_UART_GET_FIFO_SIZE(PC_PSoC_UART_SPI_BYTE_MODE_ENABLE)
        ...
        /* Get FIFO size */
        #define PC_PSoC_UART_SPI_UART_FIFO_SIZE PC_PSoC_UART_GET_FIFO_SIZE(PC_PSoC_UART_UART_BYTE_MODE_ENABLE)
    ...
    #define PC_PSoC_UART_CHECK_UART_WAKE_ENABLE (PC_PSoC_UART_UART_WAKE_ENABLE_CONST)
...
{   
     ...
     *  - PC_PSoC_UART_SPI_SLAVE 
     *  - PC_PSoC_UART_SPI_MASTE
    */
    uint32 mode;
    
    /** Submode of operation for SPI. The following defines are available 
     *  choices: 
     *  - PC_PSoC_UART_SPI_MODE_MOTOROLA 
     *  - PC_PSoC_UART_SPI_MODE_TI_COINCIDES
     *  - PC_PSoC_UART_SPI_MODE_TI_PRECEDES
     *  - PC_PSoC_UART_SPI_MODE_NATIONAL
    */
    uint32 submode;
     ...
     *  - PC_PSoC_UART_SPI_SCLK_CPHA0_CPOL0
     *  - PC_PSoC_UART_SPI_SCLK_CPHA0_CPOL1
     *  - PC_PSoC_UART_SPI_SCLK_CPHA1_CPOL0
     *  - PC_PSoC_UART_SPI_SCLK_CPHA1_CPOL1
    */
    uint32 sclkMode;
    ...
    */
     ...
     *  choices:
     *  - PC_PSoC_UART_BITS_ORDER_LSB_FIRST
     *  - PC_PSoC_UART_BITS_ORDER_MSB_FIRST
    */
    uint32 bitOrder;
     ...
     *  available choices: 
     *  - PC_PSoC_UART_SPI_TRANSFER_CONTINUOUS
     *  - PC_PSoC_UART_SPI_TRANSFER_SEPARATED
    */
     ...
     *  buffer.
     *  The PC_PSoC_UART_INTR _RX_NOT_EMPTY interrupt has to be enabled to 
    ...
    */
     ...
     *  - PC_PSoC_UART_INTR_RX_FIFO_LEVEL
    ...
    */
     ...
     *  Multiple sources are enabled by providing a value that is the OR of
     *  all of the following sources to enable:
     *  - PC_PSoC_UART_INTR_TX_FIFO_LEVEL
    ...
    */
     ...
     *  PC_PSoC_UART_SPI_SLAVE_SELECT0 corresponds to slave select 0 
     *  polarity, bit PC_PSoC_UART_SPI_SLAVE_SELECT1 – slave select 1 
     *  polarity and so on. Polarity constants are: 
     *  - PC_PSoC_UART_SPI_SS_ACTIVE_LOW 
     *  - PC_PSoC_UART_SPI_SS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
     *  PSoC Analog Coprocessor.
...
typedef struct
{
     ...
     *  choices:
     *  - PC_PSoC_UART_UART_MODE_STD
     *  - PC_PSoC_UART_UART_MODE_SMARTCARD 
     *  - PC_PSoC_UART_UART_MODE_IRDA
    */
    uint32 mode;
    
    /** Direction of operation for the UART. The following defines are available
     *  choices:
     *  - PC_PSoC_UART_UART_TX_RX
     *  - PC_PSoC_UART_UART_RX
     *  - PC_PSoC_UART_UART_TX
    */
    uint32 direction;
    ...
    */
     ...
     *  - PC_PSoC_UART_UART_PARITY_EVEN
     *  - PC_PSoC_UART_UART_PARITY_ODD
     *  - PC_PSoC_UART_UART_PARITY_NONE
    */
    uint32 parity;
    
    /** Determines the number of stop bits. The following defines are available 
     *  choices:
     *  - PC_PSoC_UART_UART_STOP_BITS_1
     *  - PC_PSoC_UART_UART_STOP_BITS_1_5
     *  - PC_PSoC_UART_UART_STOP_BITS_2
    */
    uint32 stopBits;
     ...
     *  is enabled:
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS16
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS32
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS48
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS96
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS192
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS768
     *  - PC_PSoC_UART_UART_IRDA_LP_OVS1536
    */
    uint32 oversample;
    ...
    */    
     ...
     *  - PC_PSoC_UART_UART_CTS_ACTIVE_LOW
     *  - PC_PSoC_UART_UART_CTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
     *  PSoC Analog Coprocessor.
    ...
    */
     ...
     *  - PC_PSoC_UART_UART_RTS_ ACTIVE_LOW 
     *  - PC_PSoC_UART_UART_RTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
     *  PSoC Analog Coprocessor.
...
/* SPI specific functions */
    ...
    /*******************************************************************************
    * Function Name: PC_PSoC_UART_SpiIsBusBusy
    ****************************************************************************//**
    *
...
/* UART specific functions */
    ...
    /* UART TX direction APIs */
        ...
        /*******************************************************************************
        * Function Name: PC_PSoC_UART_UartPutChar
        ****************************************************************************//**
        *
        ...
        *  Use PC_PSoC_UART_UART_MP_MARK to add a mark to create an address byte.
        *
...
#define PC_PSoC_UART_INTR_SPIM_TX_RESTORE   (PC_PSoC_UART_INTR_TX_OVERFLOW)

#define PC_PSoC_UART_INTR_SPIS_TX_RESTORE     (PC_PSoC_UART_INTR_TX_OVERFLOW | \
                                                 PC_PSoC_UART_INTR_TX_UNDERFLOW)
...
#define PC_PSoC_UART_INTR_UART_TX_RESTORE   (PC_PSoC_UART_INTR_TX_OVERFLOW  | \
                                                 PC_PSoC_UART_INTR_TX_UART_NACK | \
                                                 PC_PSoC_UART_INTR_TX_UART_DONE | \
                                                 PC_PSoC_UART_INTR_TX_UART_ARB_LOST)
...
***************************************/
    ...
    extern uint8 PC_PSoC_UART_skipStart;
