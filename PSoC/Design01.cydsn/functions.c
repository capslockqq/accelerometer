...
void mpu_init(struct MPU_9150_Acc_config *configObj) {
    configObj->accConfigData = 0b00011000;
...
void calibrateMPU9150(int32_t *correctionError) {
    ...
    */
    ...
    WriteI2CData(ACC_CONFIG, 0b00011000); //Sætter acc til 2g, dette er maksimum følsomhed
